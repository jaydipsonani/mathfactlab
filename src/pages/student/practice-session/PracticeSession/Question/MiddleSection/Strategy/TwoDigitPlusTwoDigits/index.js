...
function TwoDigitPlusTwoDigits(props) {
  ...
  function renderNode(number) {
    ...
    node = (
      <div
        className={number === 7 || number === 13 || number === 16 ? "line-5th" : "line-5th line-5th-hidden"}
        key={number}
      >
        <div className="down-label">
          {number === 7 ? first_factor : number === 13 ? (isShowHint ? hintValue : "?") : number === 16 ? "?" : ""}
        </div>
      </div>
    );
  ...
  return (
    <>
      {second_factor % 10 === 9 ? (
        <TwoDigitPlusTwoDigitsOfNine {...props} />
      ) : (
              ...
              {[1].map(number => {
                return (
                  ...
                  >
                    ...
                    >
                      <img src={arrowRight} alt="bracketBottom" />
              ...
              {[1].map(number => {
                return (
                  <div
                    ...
                    style={{
                      width: "100%",
                      marginLeft: `${((13 - startingPoint) / 20) * 100}%`,
                      position: "relative",
...
export default TwoDigitPlusTwoDigits;
