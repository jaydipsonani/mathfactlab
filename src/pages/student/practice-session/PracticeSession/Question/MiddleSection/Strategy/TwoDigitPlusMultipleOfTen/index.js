...
function TwoDigitPlusMultipleOfTen(props) {
  ...
  function renderNode(number) {
    ...
    node = (
      <div className={number === 7 || number === 13 ? "line-5th" : "line-5th line-5th-hidden"} key={number}>
        <div className="down-label">{number === 7 ? first_factor : number === 13 ? "?" : ""}</div>
      </div>
    );
...
export default TwoDigitPlusMultipleOfTen;
