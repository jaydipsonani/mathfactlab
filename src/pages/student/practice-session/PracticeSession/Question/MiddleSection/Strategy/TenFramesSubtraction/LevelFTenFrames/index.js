...
function LevelFTenFrames(props) {
  //practice question test page
  const { first_factor, hintClickedCount, isLowZoomLevel, second_factor } = props;
              ...
              return number + index * 10 <= first_factor ? (
                <div className="circle-wrapper" key={number}>
                  <div>
                    ...
                    {hintClickedCount === 1 && number + index * 10 <= second_factor && (
                      <img src={cross} alt="Dice1" className="dice-img cross-img" />
                    )}
                  </div>
                </div>
...
export default LevelFTenFrames;
