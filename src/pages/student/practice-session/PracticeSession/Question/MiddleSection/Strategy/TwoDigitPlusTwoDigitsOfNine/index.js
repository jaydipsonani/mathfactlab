...
function TwoDigitPlusTwoDigitsOfNine(props) {
  ...
  function renderNode(number) {
    ...
    node = (
      <div
        className={number === 7 || number === 14 || number === 16 ? "line-5th" : "line-5th line-5th-hidden"}
        key={number}
      >
        <div className="down-label">
          {number === 7 ? first_factor : number === 14 ? "?" : number === 16 ? (isShowHint ? hintValue : "?") : ""}
        </div>
      </div>
    );
          ...
          {[1].map(number => {
            return (
              ...
              >
                ...
                >
                  <img src={arrowRight} alt="bracketBottom" style={{ height: "100px" }} />
          ...
          {[1].map(number => {
            return (
              ...
              >
                ...
                >
                  <img src={arrowLeft} alt="bracketBottom" style={{ height: "20px" }} />
