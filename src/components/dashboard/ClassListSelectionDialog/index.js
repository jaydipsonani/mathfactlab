...
const ClassListSelectionDialog = props => {
  ...
  const handleCloseDailog = () => {
    ...
    if (localStorage.getItem("is_welcome_popup_google_sync")) {
...
export default ClassListSelectionDialog;
