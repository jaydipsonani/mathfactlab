...
import StudentsReport from "components/dashboard/StudentsReport";
...
const SideBar = ({
  ...
  const menus = [
    ...
    {
      path: role_id === userRole.SCHOOL_ADMIN.role_id ? "/admin/classes" : "/teacher/classes",
      // path: "/admin/classes",
      label: "Classes",
    ...
    {
      path: role_id === userRole.SCHOOL_ADMIN.role_id ? "/admin/teaching-tools" : "/teacher/teaching-tools",
    ...
    },
    {
      path:
        role_id === userRole.SCHOOL_ADMIN.role_id
          ? "/admin/classroom-implementation"
  ...
  return (
    <>
      ...
      {isShowStudentReports && (
        <StudentsReport isOpenPopup={isShowStudentReports} closePopup={setIsShowStudentReports} />
      )}
      {isShowGrowthGaugePopup && (
        <GrowthGauge user={""} close={setIsShowGrowthGaugePopup} isShowProgressTablePopup={isShowGrowthGaugePopup} />
      )}
    </>
  );
};
